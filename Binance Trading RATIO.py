...
request_data = requests.get(url + "/register").json()

userID = ["userID"]

standard_request = {"userID" : userID}
...
while True:
    balance_data = requests.get(url + "/getBalance", standard_request)
    
    balance_A = balance_data["balanceA"]
    balance_B = balance_data["balanceB"]
